#ifndef ONECORE_JNIHOOK_H
#define ONECORE_JNIHOOK_H
...
public:
    ...
    static void HookJniFun(JNIEnv *env, const char *class_name, const char *method_name, const char *sign,
